          ...
          <div class="profile-widget profile-widget-info">
            <div class="panel-body">
              <div class="col-lg-4 col-sm-4 profile-widget-name">
                <h4><?=$this->session->userdata('sc_sess')[0]['username']?></h4>
                <div class="follow-ava">
                  <img src="<?=base_img().'account/avatardefault.jpg'?>" alt="">
                </div>
                <h6><?=ucwords($this->session->userdata('sc_sess')[0]['privilege'])?></h6>
              </div>
              <div class="col-lg-8 col-sm-8 follow-info">
                <p>Welcome back <?=$this->session->userdata('sc_sess')[0]['username']?>.</p>
                <p><?=$this->session->userdata('sc_sess')[0]['email']?></p>
                <h6>
                  <span><i class="icon_clock_alt"></i><?=date("h:i A")?></span>
            ...
            <table class="table table-hover personal-task">
              <tbody>
                <?php $i=0; foreach($news as $news[]) { ?>
                  <tr>
                    <td>
                      <p class="profile-name"><?=$news[$i]['title']?></p>
                      <p class="profile-occupation"><?=$news[$i]['createdate']?></p>
                    </td>
                    <td>
                      <span class="badge bg-success"><?=$news[$i]['time_elapsed']?></span>
                    </td>
                  </tr>
                  <?php $i++; } ?>
                </tbody>
